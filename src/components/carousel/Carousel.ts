...
export class Carousel {
   ...
   *
   * Usado antes da entrada: a home nasce com START_SECTION de frente, ou, numa
   * volta sem BFCache, no segmento de onde o visitante saiu — é uma restauração
   * de estado, não um novo gesto dele. */
